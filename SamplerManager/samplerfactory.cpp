...
std::unique_ptr<ISampler> SamplerFactory::CreateSampler(const unsigned samplerNo, const std::unique_ptr<ILinearFeedbackShiftRegister> &lfsr,
                                                                  ...
                                                                  double periodRatio, double modulationIndex)
{
    ...
    return it->second(lfsr, periodicSignal, timeJitterSignal, periodRatio, modulationIndex);
}
